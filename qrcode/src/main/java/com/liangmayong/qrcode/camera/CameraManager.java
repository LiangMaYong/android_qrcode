...
public final class CameraManager {
    ...
    private int MAX_FRAME_WIDTH = 360;
    private int MAX_FRAME_HEIGHT = 360;
    ...
    public final void setFramingMinAndMax(int minW, int minH, int maxW, int maxH) {
        this.MIN_FRAME_WIDTH = minW;
        this.MIN_FRAME_HEIGHT = minH;
        this.MAX_FRAME_WIDTH = maxW;
        this.MAX_FRAME_HEIGHT = maxH;
    ...
    private CameraManager(Context context) {
        ...
        int max = Math.min(height * 5 / 8, width * 5 / 8);
